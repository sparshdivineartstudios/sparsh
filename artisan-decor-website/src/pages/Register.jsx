    ...
    <main className="min-h-screen flex items-center justify-center py-24 px-8">
      ...
      >
        <div className="text-center mb-8">
          <h2 className="font-serif text-3xl text-stone-900 dark:text-stone-50 font-medium">Join Sparsh</h2>
          <p className="font-sans text-sm text-stone-500 mt-2">Create your studio account</p>
        </div>

        {error && <p className="text-red-500 text-xs tracking-widest uppercase mb-6 text-center">{error}</p>}
        {success && <p className="text-emerald-500 text-xs tracking-widest uppercase mb-6 text-center">{success}</p>}
